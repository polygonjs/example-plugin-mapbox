...
// sop
import {AddSopNode} from '@polygonjs/polygonjs/src/engine/nodes/sop/Add';
...
import {NormalsSopNode} from '@polygonjs/polygonjs/src/engine/nodes/sop/Normals';
import {ObjectPropertiesSopNode} from '@polygonjs/polygonjs/src/engine/nodes/sop/ObjectProperties';
import {PointSopNode} from '@polygonjs/polygonjs/src/engine/nodes/sop/Point';
...
export class PolySceneWithNodeMap_default extends PolyScene {
	...
	node(path: '/geo1/file1'): FileSopNode;
	...
	node(path: '/geo1/file2'): FileSopNode;
